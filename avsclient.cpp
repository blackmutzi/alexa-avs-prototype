...
<<<<<<< HEAD
       ...
       case EVENT_STREAM_PLAYBACK_STOPPED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackStoppedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_FINISHED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackFinishedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_FAILED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackFailedEvent( message_id , &param ));
       break;

       case EVENT_STREAM_PLAYBACK_PAUSED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackPausedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_RESUME:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackResumedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_NEARLY_FINISHED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackNearlyFinishedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PROGRESS_REPORT_DELAY_ELAPSED:
                data = getRequestBuilder()->buildEventStream( factory.createProgressReportDelayElapsedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PROGRESS_REPORT_INTERVAL_ELAPSED:
                data = getRequestBuilder()->buildEventStream( factory.createProgressReportIntervalElapsedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_STUTTER_STARTED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackStutterStartedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_STUTTER_FINISHED:
                data = getRequestBuilder()->buildEventStream( factory.createPlaybackStutterFinishedEvent( message_id , m_sync_event->playbackState->token ,  m_sync_event->playbackState->offsetInMilliseconds ));
       break;

       case EVENT_STREAM_PLAYBACK_QUEUE_CLEARED:
